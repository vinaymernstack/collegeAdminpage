...
import StudentSidenav from '../sidenavstudent/sidenavstudent'
...
class studentreport extends Component{
    ...
    componentDidMount(){
        var reg = localStorage.getItem("student");
        $(".regn").val(reg);
        var marksdataa = {
            option : "reports",
            regno : reg
            ...
            <div>
                ...
                <div class="content-page">
                      ...
                      <div class="form-inline" >
                              ...
                              <input type="text" class="form-control regid inputmarks regn"  id="email" disabled = "disabled"/>
                              </div>
